...
<div>
	<div class="container home-page" style="opacity: 1;">
		...
		<div class="text-zone">
			<h1 aria-label=" Hi,I’m Taha, Developer, Software Engineer." class="blast-root">
			<span class="blast" aria-hidden="true" style="opacity:1;">H</span><span class="blast" aria-hidden="true" style="opacity:1;">i</span><span class="blast" aria-hidden="true" style="opacity:1;">,</span>
			...
			<img src="../assets/jj.png" alt="Software Engineer" class="animation-logo"><span class="blast" aria-hidden="true" style="opacity:1;">a</span><span class="blast" aria-hidden="true" style="opacity:1;">h</span><span class="blast" aria-hidden="true" style="opacity:1;">a</span><span class="blast" aria-hidden="true" style="opacity:1;">,</span>
			<br/>
			<span class="blast" aria-hidden="true" style="opacity:1;">S</span><span class="blast" aria-hidden="true" style="opacity:1;">o</span><span class="blast" aria-hidden="true" style="opacity:1;">f</span><span class="blast" aria-hidden="true" style="opacity:1;">t</span><span class="blast" aria-hidden="true" style="opacity:1;">w</span><span class="blast" aria-hidden="true" style="opacity:1;">a</span><span class="blast" aria-hidden="true" style="opacity:1;">r</span><span class="blast" aria-hidden="true" style="opacity:1;">e</span> <span class="blast" aria-hidden="true" style="opacity:1;">E</span><span class="blast" aria-hidden="true" style="opacity:1;">n</span><span class="blast" aria-hidden="true" style="opacity:1;">g</span><span class="blast" aria-hidden="true" style="opacity:1;">i</span><span class="blast" aria-hidden="true" style="opacity:1;">n</span><span class="blast" aria-hidden="true" style="opacity:1;">e</span><span class="blast" aria-hidden="true" style="opacity:1;">e</span><span class="blast" aria-hidden="true" style="opacity:1;">r</span><span class="blast" aria-hidden="true" style="opacity:1;">.</span>
			</h1>
			<h2>Android / Full stack / Node / Python / Vue
			
			</h2>
			<router-link rel="contact" to="/contact" class="flat-button">CONTACT ME
		...
		<!-- 		<div id="bulb" class="bulb">
			<a class="animated" href="file:///C:/Users/tpourjalali/Desktop/tahahojati.github.io/index.html">
			</a>
		</div> -->
	</div>
	<div class="bg" style="opacity: 1;">
		<!-- <img class="jb" src="./styles/jblue.png" alt="Wordpress,  Developer Logo part9" style="opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);"> -->
		<!-- <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="300.000000pt" height="457.000000pt" viewBox="0 0 300.000000 457.000000" preserveAspectRatio="xMidYMid meet" class=" drawsvg-initialized ">
					<g transform="translate(0.000000,457.000000) scale(0.100000,-0.100000)" stroke="#4d4d4e" stroke-width="10" fill="none">
					...
					<path d="M1683 3265 c0 -8 4 -12 9 -9 5 3 6 10 3 15 -9 13 -12 11 -12 -6z" style="stroke-dasharray: 61.131, 61.131; stroke-dashoffset: 0;"></path>
