...
rem powershell "aws s3 cp dist/build.js s3://www.tpourjalali.com/dist/ --acl public-read"
rem powershell "aws s3 cp dist/resume.pdf s3://www.tpourjalali.com/dist/ --acl public-read"
