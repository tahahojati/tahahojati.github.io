...
.factory('projectFactory', ['$sce', function($sce) {
    var fac = [{
        ...
        live:'http://programs.crdg.hawaii.edu:81',
        ...
        bodyRows: [{
            ...
            text: "<h2> Current State </h2> <p> This project is under active development.  Currently, the website is capable of gathering fieldtrip data.  The expected deployment date for this project is end of October. You may visit the live preview of the project by clicking on the link provided in the cover picture above.  You may login to the preview website as administrator using email t@t.com and password tttttt.  Note that several features of the website do not function on the preview due to the limitations of our in house server.",
